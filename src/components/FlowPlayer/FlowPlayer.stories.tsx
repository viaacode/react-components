...
export const AudioWithLowAmplitudePeak: Story = {
	args: {
		...MOCK_FLOW_PLAYER_PROPS_FULL,
		src: [
			{
		...
		type: 'audio',
		poster: 'https://placehold.co/1920x1080',
		waveformData: peakLowAmplitudeJson.data,
	},
	render: Template,
};
	...
	args: {
		...
		customControlsConfig: {
			colors: {
				...
				activeButtonColor: '#ff6b6b',
				cuepointColor: '#ff6b6b',
				buttonHoverColor: 'rgba(255, 255, 255, 0.15)',
				activeButtonHoverColor: '#ff8585',
				buttonPressedColor: 'rgba(255, 255, 255, 0.25)',
				activeButtonPressedColor: '#e35555',
				progressTrackHoverColor: '#3a3a3a',
				buttonFocusColor: '#ff6b6b',
				buttonTextColor: '#f5f5f5',
				activeButtonTextColor: '#f5f5f5',
			},
		},
	},
	render: Template,
