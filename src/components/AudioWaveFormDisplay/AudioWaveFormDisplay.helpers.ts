...
// Bar geometry traced from the original design asset: 30 vertical bars, 3 units apart starting
// at x=0.9, centered on y=21.6, in a 92x44 viewBox.
...
// Exposed for consumers using this as FlowPlayer's `peakVisual` - its horizontal padding needs
// to be accounted for via `customControlsConfig.peakVisualContentInset` (see PeakDisplay.tsx),
// or the fake-playing progress reveal "plays through" blank space before any bar is visible.
